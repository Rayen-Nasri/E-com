    ...
    <div className="min-h-screen bg-[#F5EDDD]">
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.h1 
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="text-4xl font-serif font-bold mb-8 text-center text-[#5D4037]"
        >
          Complete Your Order
        </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          >
            <form onSubmit={handleSubmit} className="bg-white/30 p-8 rounded-lg shadow-lg border border-[#E6D7C3]">
              <h2 className="text-2xl font-serif font-semibold mb-6 text-[#5D4037] border-b border-[#E6D7C3] pb-3">Shipping Information</h2>
              ...
              <h2 className="text-2xl font-serif font-semibold mb-6 text-[#5D4037] border-b border-[#E6D7C3] pb-3">Payment Information</h2>
          ...
          >
            <div className="bg-white/30 p-6 rounded-lg shadow-lg border border-[#E6D7C3] sticky top-6">
              <h2 className="text-2xl font-serif font-semibold mb-6 text-[#5D4037] border-b border-[#E6D7C3] pb-3">Order Summary</h2>
