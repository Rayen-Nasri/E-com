    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex items-start justify-end backdrop-blur-sm bg-black/30"
        >
          <motion.div
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            ...
            className="h-full w-full max-w-md bg-[#F5EDDD] shadow-xl flex flex-col">
