...
export const NavBarSee = () => {
  ...
  return (
    <nav className={verify ? "flex items-center justify-between bg-[#F5EDDD] px-[17px] lg:px-15 py-3 " : "bg-[#F5EDDD] px-15 flex py-3"} >
      {/* Logo */}
          ...
          <>
            <div className="justify-end space-x-8 ml-auto lg:block">
              <Link
                ...
                relative top-[2px] rounded-[20px] text-center bg-black text-white "
              ...
              <Link
               ...
               wtext-black top-[2px] hidden lg:block relative rounded-[20px] text-center bg-transparent"
