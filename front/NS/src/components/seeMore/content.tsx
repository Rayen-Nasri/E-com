...
export const Content = () => {
    ...
    return (
        <section>
            <main className="relative overflow-hidden z-0">
                ...
                <div className=" container lg:mx-auto py-10 xl:py-5 2xl:py-15 lg:flex lg:flex-col lg:flex-row items-center justify-between z-1">
                    <div className="ml-[5%] xl:w-1/2 z-1 xl:ml-30">
                        <h1 className="text-[33px] lg:text-5xl md:text-[48px] xl:text-[44px] 2xl:text-[50px] mt-20 z-1 lg:mt-10  font-medium text-[#876D49] leading-tight mb-10 ">
                            Noble Nurturing For
                            <br />
                    ...
                    <div className="flex 2xl:w-1/2 justify-end mr-10 xl:mr-30 z-1">
                        <div className="absolute md:relative lg:relative overflow-hidden ">
                            <img src={contentSee} alt="" loading="lazy" className='lg:block hidden 2xl:h-170' />
                        </div>
                    </div>
                </div>
            ...
            <div className='flex mx-auto h-[3px]  w-[90%] bg-[#B4936D]/80 mt-[40px] lg:mt-[0px] mb-12 xl:mb-15 2xl:mb-13 lg:mt-[-10px]' />
        </section>
